...
output:
  ...
  mainfont: "Helvetica"
urlcolor: blue
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), 'reports/motus_station_report_Port-Maitland.html')) })
---
