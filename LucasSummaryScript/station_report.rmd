...
```{r load functions and log into Motus}

setwd('D:/OneDrive/R/scripts/motus')
# 
# # log into Motus (not actually a function, just logs in during sourcing)
# source('motus_login.R')

# function to download data
source('download_data.R')

# function to map taghits_tracks for whatever group of tags is passed in
source('map_tracks.R')
...
# Filtering this section out below since Lucas was loading his data differently
# and I'm directly loading an RDS file

Sys.setenv('motus_userAuth' = '')

receiver.name <- "Saunders" # actually the site name


# Lucas's function downloads all the receivers associated with this particular
# site (and project ID, if passed in) and saves an .RDS of the alltags table
# for each receiver (at this point possibly containing data from other sites)
# it's named after the receiver ID
downloadMotus_recvData(receiver.name, projectID, dir)

# df of the receiver deployments csv     
