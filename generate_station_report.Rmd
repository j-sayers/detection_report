...
################################################################################
###
###  This markdown report must be rendered from within from STATION_REPORT.R
...
### Station: `r first_deploy[station_name]`

Location: <a href= `r latlon`>`r lat`, `r lon`</a>

Start Date: `r format(as.Date(first_deploy$dt_start), '%B %d, %Y')`
